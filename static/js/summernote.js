...
(function (factory) {
  ...
  var dialog = renderer.create('<div class="modal" aria-hidden="false" tabindex="-1"/>', function ($node, options) {
    ...
    $node.html([
      ...
      '      <h4 class="modal-title text-success">' + options.title + '</h4>' +
      '    </div>' : ''
      ),
    ...
    this.initialize = function () {
      ...
      (!options.disableLinkTarget ?
          $('<div/>').append(ui.checkbox({ id: 'sn-checkbox-open-in-new-window', text: lang.link.openInNewWindow, checked: true }).render())
              .html()
          : '');
      var footer = '<button href="#" class="btn btn-success note-btn note-btn-primary ' +
  ...
  var ImageDialog = function (context) {
    ...
    this.initialize = function () {
      ...
      */
      ...
      '<div class="form-group note-form-group note-group-select-from-files">' +
        '<label class="note-form-label">' + lang.image.selectFromFiles + '</label>' +
        '<div class="input-group" id="image-field-static-page">' +
          '<input disabled="disabled" class="form-control" id="image-field-file-name" type="text">' +
          imageLimitation +
          '<span class="input-group-btn">' +
            '<div class="btn btn-default" id="image-field-input">' +
              '<i class="fa fa-file-image-o"></i>&nbsp;' +
              '<span id="image-field-input-title">Загрузить изображение</span>' +
              '<input class="note-image-input form-control note-form-control note-input" name="image" id="files" accept="image/*" type="file">' +
            '</div>' +
          '</span>' +
        '</div>' +
      '</div>' +
